...
All updates to this module are documented in our [CHANGELOG](https://github.com/sendgrid/smtpapi-csharp/blob/HEAD/CHANGELOG.md).
...
For a sample implementation, check the [Example](https://github.com/sendgrid/smtpapi-csharp/blob/HEAD/Smtpapi/Example/Program.cs)
...
- [Example Code](https://github.com/sendgrid/smtpapi-csharp/blob/HEAD/Smtpapi/Example/Program.cs)
...
We encourage contribution to our projects, please see our [CONTRIBUTING](https://github.com/sendgrid/smtpapi-csharp/blob/HEAD/CONTRIBUTING.md) guide for details.

Quick links:

- [Feature Request](https://github.com/sendgrid/smtpapi-csharp/blob/HEAD/CONTRIBUTING.md)
- [Bug Reports](https://github.com/sendgrid/smtpapi-csharp/blob/HEAD/CONTRIBUTING.md#submit-a-bug-report)
- [Improvements to the Codebase](https://github.com/sendgrid/smtpapi-csharp/blob/HEAD/CONTRIBUTING.md#improvements-to-the-codebase)
